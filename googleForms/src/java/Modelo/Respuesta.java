...
public class Respuesta implements Serializable {
    ...
    @Lob
    @Size(min = 1, max = 65535)
    @Column(name = "respouestas")
    private String respouestas;
    ...
    public Respuesta(Integer id, String nombre, String respouestas) {
        this.id = id;
        this.nombre = nombre;
        this.respouestas = respouestas;
    }
    ...
    public String getRespouestas() {
        return respouestas;
    }

    public void setRespouestas(String respouestas) {
        this.respouestas = respouestas;
    }
